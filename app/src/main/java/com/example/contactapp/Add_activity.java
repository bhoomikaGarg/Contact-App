    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            if(checkPhone(mobile) && checkMail(mail) && empty(name,mobile)){
                ...
                Toast.makeText(getApplicationContext(), "Phone number incorrect ", Toast.LENGTH_SHORT).show();
            }
                ...
                if (checkMail(mail)==false){
                    Toast.makeText(getApplicationContext(), "Mail incorrect ", Toast.LENGTH_SHORT).show();
                }
            }
